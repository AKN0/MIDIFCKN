...
public class SoundModel {
   ...
   //5th Row Sound
    ...
    ////////////////////////////////////METHODS//////////////////////////////////////////
    public AudioClip getButtonSound(int choice){ // This is our getter
        return sampleGrid[choice];
    }
    
    public AudioClip getTrackSound(int choice) {// This is the track getter
    ...
    /**
     * This method is used for replacing the sound within one of the sound buttons, or a setter
